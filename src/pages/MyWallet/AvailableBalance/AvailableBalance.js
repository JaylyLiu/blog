...
class AvailableBalance extends React.Component{
  render(){
      return(
            <div className="my-balance-availablebalance" >
                <span className="my-balance-availablebalance-span1">
                    Available Balance
                </span>
                
                <span className="my-balance-availablebalance-span2">
                    $ 355.50 USD
                </span>
                <span className="my-balance-availablebalance-span3">
                    CNY 2343.15
                </span>
                
                <span className="my-balance-availablebalance-span4">
